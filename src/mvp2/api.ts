...
export const api={
 ...
 async saveSceneDocument(id:string,creativeDocument:CreativeDocument){return request<Campaign>(`/api/campaigns/${encodeURIComponent(id)}`,{method:"PATCH",body:JSON.stringify({creativeDocument,status:"creative"})})},
