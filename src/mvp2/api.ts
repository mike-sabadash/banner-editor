...
export const api={
 ...
 async saveSceneDocument(id:string,creativeDocument:CreativeDocument){return request<Campaign>(`/api/campaigns/${encodeURIComponent(id)}/scene-document`,{method:"PATCH",body:JSON.stringify({creativeDocument})})},
